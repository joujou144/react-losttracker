...
const MissingPersonDetails = () => {
  ...
  return (
        ...
        <div className="flex flex-col items-center flex-1 gap-6 self-start w-full 2xl:w-[60%]">
          ...
          <InfoBoard title={upperCase("who to contact")}>
            <p className="text-pretty lg:text-[15px]">
              ...
              you are encouraged to contact the Local Police Department at
              123-456-789, ask for Detective Jane Doe. Please include case
              number <span className="font-normal text-blue-300">555 555</span>{" "}
              as you will need it.
            </p>
          </InfoBoard>
          ...
          <AdviceBoard title="Be Advised">
            <p>
              If you encounter{" "}
              <span className="font-normal text-blue-300">{post.name}</span>,
              avoid direct interaction. Instead, dial your local emergency
              number, such as 911, or the law enforcement contact number listed
              in this record. They will guide you on the appropriate steps.
    ...
    "Tip" link in the top menu of this page. */}
            ...
            <p className="mt-4">
              *** If the information contained in this missing persons profile
              is inaccurate, needs to be updated, or the person has been
              located, please let our staff know as soon as possible. Thank you.
              ***
            </p>
          </AdviceBoard>
        </div>
